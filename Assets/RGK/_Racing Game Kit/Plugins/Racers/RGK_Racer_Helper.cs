...
namespace RacingGameKit.Racers
{
    ...
    public class  RGK_Racer_Helper:MonoBehaviour
    {
        ...
        void Update()
        {
            CarSpeedKm = Mathf.Round(CachedTransform.rigidbody.velocity.magnitude * 3.6f);
        }
        ...
        private static void Resetcar()
        {
            ...
            CachedTransform.rigidbody.velocity = Vector3.zero;
            CachedTransform.rigidbody.angularVelocity = Vector3.zero;
