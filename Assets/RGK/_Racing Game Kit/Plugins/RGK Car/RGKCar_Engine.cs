...
namespace RacingGameKit.RGKCar
{
    ...
    public class RGKCar_Engine : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            DefinedAngularDrag = transform.rigidbody.angularDrag;
            DefinedForwardDrag = transform.rigidbody.drag;
        ...
        void FixedUpdate()
        {
            ...
            this.SpeedAsKM = base.rigidbody.velocity.magnitude * 3.6f;
        ...
        void ApplySurfaceDrag(float ForwardDrag, float AngularDrag)
        {
            ...
            transform.rigidbody.drag = ForwardDrag;
            transform.rigidbody.angularDrag = AngularDrag;
        }
