    ...
    public class RGKCar_CarAudioAdvanced : MonoBehaviour
    {
       ...
       private AudioClip BrakeDisk;
        ...
        private void SetupAudioSources()
        {
            ...
            aChannel1.audio.loop = true;
            aChannel1.audio.volume = 1;
            ...
            aChannel2.audio.loop = true;
            aChannel2.audio.volume = 1;
            ...
            if (TurboPopHigh != null)
            {
                ...
                aChannelTurbo.audio.loop = false;
                aChannelTurbo.audio.volume = 1;
            ...
            if (SpeedHiss != null)
            {
                ...
                aChannelHiss.audio.loop = true;
                aChannelHiss.audio.volume = 0;
                aChannelHiss.audio.pitch = 0;
                aChannelHiss.audio.clip = SpeedHiss;
            ...
            aChannelSkid.audio.loop = true;
            aChannelSkid.audio.volume = 0;
            aChannelSkid.audio.clip = Skid;
            ...
            if (BackfireShort != null || BackfireLong != null)
            {
                ...
                aChannelBackfire.audio.loop = false;
                aChannelBackfire.audio.volume = 1;
                aChannelBackfire.audio.clip = BackfireShort;
            ...
            aChannelSurface.audio.loop = true;
            aChannelSurface.audio.volume = 0;
            aChannelSurface.audio.pitch = 1;
            aChannelSurface.audio.clip = SurfaceSound;
            ...
            if (GearChange != null)
            {
                ...
                aChannelGearchange.audio.loop = false;
                aChannelGearchange.audio.volume = 1;
            ...
            if (BrakeDisk != null)
            {
                ...
                aChannelBrakeDisk.audio.loop = true;
                aChannelBrakeDisk.audio.volume = 0;
                aChannelBrakeDisk.audio.clip = BrakeDisk;
        ...
        private void ApplySurface()
        {
            ...
            {
                AudioChannelSurface.audio.clip = SurfaceSound;
        ...
        public void PopTurbo(float TurboValue)
        {
            if (TurboPopHigh != null && TurboWaste != null)
            {
                ...
                if (TurboValue > 0.9f)
                {
                    AudioChannelTurbo.audio.clip = TurboPopHigh;
                }
                else if (TurboValue >= 0.5f && TurboValue < 0.9f)
                {
                    AudioChannelTurbo.audio.clip = TurboWaste;
                }
                else
                {
        ...
        public void PopGear()
        {
            if (GearChange != null && AudioChannelGearChange!=null)
            {
                 ...
                 AudioChannelGearChange.audio.clip = GearChange; 
        ...
        {
            AudioChannelSkid.audio.clip = Skid;
