...
namespace RacingGameKit
{
    ...
    public class Race_Manager : MonoBehaviour
    {
        ...
        /// </summary>
        [HideInInspector]
        public int RacePlayers = 2;          //Total racers will in the race
        /// <summary>
        ...
        //Distance Objects
        public float DistancePointDensity = 50f;
        ...
        /// Camera Instance
        /// </summary>
        private RacingGameKit.Interfaces.IRGKCamera GameCamereComponent = null;
