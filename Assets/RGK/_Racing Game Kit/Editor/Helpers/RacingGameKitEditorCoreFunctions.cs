    ...
    public static class CoreFunctions
    {
        ...
        private static void CreateWaypointItemFromManager(WayPointManager WPManager)
        {
            ...
            while (NewItemName == null)
            {
                ...
                if (WPManager.gameObject.transform.FindChild(NewItemName) != null)
                {
                    NewItemName = null;
                }
            }
        ...
        private static void CreateWaypointItemFromItem(WayPointItem WPItem)
        {
            ...
            while (NewItemName == null)
            {
                ...
                if (WPManagerObject.gameObject.transform.FindChild(NewItemName) != null)
                {
                    NewItemName = null;
                }
            }
        ...
        private static void CreateRacingLineItemFromManager(RacingLineManager RLManager)
        {
            ...
            while (NewItemName == null)
            {
                ...
                if (RLManager.gameObject.transform.FindChild(NewItemName) != null)
                {
                    NewItemName = null;
                }
            }
        ...
        private static void CreateRacingLineItemFromItem(RacingLineItem RLItem)
        {
            ...
            while (NewItemName == null)
            {
                ...
                if (RacingLineManager.gameObject.transform.FindChild(NewItemName) != null)
                {
                    NewItemName = null;
                }
            }
        ...
        public static void CreateRaceManager()
        {
            ...
            GUISkin DefaultSkin = Resources.LoadAssetAtPath("Assets/_Racing Game Kit/UI/Skins/RSK_Default.guiskin", typeof(GUISkin)) as GUISkin;
        ...
        public static void CreateStartPoint()
        {
            ...
            if (WPObject == null || WPObject.transform.GetChildCount() == 0)
            {
        ...
        public static void AddVerticalProgress()
        {
            ...
            //PROGRESSBG
            Texture2D imgProgressBG = Resources.LoadAssetAtPath("Assets/_Racing Game Kit/UI/Progress/progress_bg.png", typeof(Texture2D)) as Texture2D;
            ...
            Texture2D imgCompletedBG = Resources.LoadAssetAtPath("Assets/_Racing Game Kit/UI/Progress/progress_complete.png", typeof(Texture2D)) as Texture2D;
            GProgressHorizontal.PlayerCompleteForeground = imgCompletedBG;
            GProgressHorizontal.PlayerCompleteOffset = new Vector2(0f, 0f);
            //STARTPOINT IMAGE
            Texture2D imgStartIcon = Resources.LoadAssetAtPath("Assets/_Racing Game Kit/UI/Progress/_VerticalIcons/progress_start_vert.png", typeof(Texture2D)) as Texture2D;
            GProgressHorizontal.StartPointIcon = imgStartIcon;
            GProgressHorizontal.StartPointOffset = new Vector2(4.650143f, 0f);
            //ENDPOINT IMAGE
            Texture2D imgFinishtIcon = Resources.LoadAssetAtPath("Assets/_Racing Game Kit/UI/Progress/_VerticalIcons/progress_finish_vert.png", typeof(Texture2D)) as Texture2D;
            GProgressHorizontal.EndPointIcon = imgFinishtIcon;
            GProgressHorizontal.EndPointOffset = new Vector2(7.138184f, 3.063957f);
            //SEPERATOR IMAGE
            Texture2D imgSeperator = Resources.LoadAssetAtPath("Assets/_Racing Game Kit/UI/Progress/_VerticalIcons/progress_seperator_vert.png", typeof(Texture2D)) as Texture2D;
            GProgressHorizontal.LapSeperatorIcon = imgSeperator;
            GProgressHorizontal.LapSeperatorOffset = new Vector2(10f, 0f);
            //RACERICON
            Texture2D imgPlayerIcon = Resources.LoadAssetAtPath("Assets/_Racing Game Kit/UI/Progress/_VerticalIcons/arrow_player_vert.png", typeof(Texture2D)) as Texture2D;
            GProgressHorizontal.RacerIcon = imgPlayerIcon;
            //RIVALICON
            Texture2D imgRivalIcon = Resources.LoadAssetAtPath("Assets/_Racing Game Kit/UI/Progress/_VerticalIcons/Arrow_rival_vert.png", typeof(Texture2D)) as Texture2D;
            GProgressHorizontal.RivalIcon = imgRivalIcon;
            //RIVALDESTROYED
            Texture2D imgDestroyedIcon = Resources.LoadAssetAtPath("Assets/_Racing Game Kit/UI/Progress/_VerticalIcons/arrow_destroyed_vert.png", typeof(Texture2D)) as Texture2D;
        ...
        public static void AddHorizontalProgress()
        {
            ...
            //STARTPOINT IMAGE
            Texture2D imgStartIcon = Resources.LoadAssetAtPath("Assets/_Racing Game Kit/UI/Progress/_HorizontalIcons/progress_start.png", typeof(Texture2D)) as Texture2D;
            GProgressHorizontal.StartPointIcon = imgStartIcon;
            GProgressHorizontal.StartPointOffset = new Vector2(0f, 27.6f);
            //ENDPOINT IMAGE
            Texture2D imgFinishtIcon = Resources.LoadAssetAtPath("Assets/_Racing Game Kit/UI/Progress/_HorizontalIcons/progress_finish.png", typeof(Texture2D)) as Texture2D;
            GProgressHorizontal.EndPointIcon = imgFinishtIcon;
            GProgressHorizontal.EndPointOffset = new Vector2(0f, 27.6f);
            //SEPERATOR IMAGE
            Texture2D imgSeperator = Resources.LoadAssetAtPath("Assets/_Racing Game Kit/UI/Progress/_HorizontalIcons/progress_seperator.png", typeof(Texture2D)) as Texture2D;
            GProgressHorizontal.LapSeperatorIcon = imgSeperator;
            GProgressHorizontal.LapSeperatorOffset = new Vector2(0f, 31.3f);
            //RACERICON
            Texture2D imgPlayerIcon = Resources.LoadAssetAtPath("Assets/_Racing Game Kit/UI/Progress/_HorizontalIcons/arrow_player.png", typeof(Texture2D)) as Texture2D;
            GProgressHorizontal.RacerIcon = imgPlayerIcon;
            //RIVALICON
            Texture2D imgRivalIcon = Resources.LoadAssetAtPath("Assets/_Racing Game Kit/UI/Progress/_HorizontalIcons/Arrow_rival.png", typeof(Texture2D)) as Texture2D;
            GProgressHorizontal.RivalIcon = imgRivalIcon;
            //RIVALDESTROYED
            Texture2D imgDestroyedIcon = Resources.LoadAssetAtPath("Assets/_Racing Game Kit/UI/Progress/_HorizontalIcons/arrow_destroyed.png", typeof(Texture2D)) as Texture2D;
            GProgressHorizontal.DestroyedIcon = imgDestroyedIcon;
        ...
        private static void CreateSpawnPointItemFromManager(SpawnPointManager SPManager)
        {
            ...
            while (NewItemName == null)
            {
                ...
                if (SPManager.gameObject.transform.FindChild(NewItemName) != null)
                {
                    NewItemName = null;
                    return;
                }
        ...
        private static void CreateCheckPointItemFromManager(CheckPointManager CPManager)
        {
            ...
            while (NewItemName == null)
            {
                ...
                if (CPManager.gameObject.transform.FindChild(NewItemName) != null)
                {
                    NewItemName = null;
                    return;
                }
        ...
        private static void CreateCheckPointItemFromItem(CheckPointItem CPItem)
        {
            ...
            while (name == null)
            {
                ...
                if (CPManager.gameObject.transform.FindChild(name) != null)
                {
                    name = null;
                    return;
                }
